...
MODEL_NAMES1="alexnet efficientnet_b7 mobilenet_v3_large resnet50 resnet101 vgg19 vit_base_patch16_224 mlp_mixer_b16_224"
MODEL_NAMES="alexnet efficientnet_b7"
WORKING_DIR=$(pwd)
